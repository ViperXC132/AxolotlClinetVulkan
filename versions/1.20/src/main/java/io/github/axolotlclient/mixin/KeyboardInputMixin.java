...
public abstract class KeyboardInputMixin {
	 ...
	 * @author moehreag
	 */
	@WrapOperation(method = "tick", at = @At(value = "INVOKE", target = "Lnet/minecraft/client/option/KeyBind;isPressed()Z", ordinal = 5))
	public boolean axolotlclient$toggleSneak(KeyBind instance, Operation<Boolean> original) {

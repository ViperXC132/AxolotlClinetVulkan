...
public class TrapUpgrade extends TeamUpgrade {
	...
	public enum TrapType {
		...
		COUNTER_OFFENSIVE((graphics, x, y, width, height, unused) ->
			graphics.blitSprite(RenderType::guiTextured, Minecraft.getInstance().getMobEffectTextures().get(MobEffects.SPEED), x, y, 0, width, height)),
		...
		MINER_FATIGUE((graphics, x, y, width, height, unused) ->
			graphics.blitSprite(RenderType::guiTextured, Minecraft.getInstance().getMobEffectTextures().get(MobEffects.MINING_FATIGUE), x, y, 0, width, height));

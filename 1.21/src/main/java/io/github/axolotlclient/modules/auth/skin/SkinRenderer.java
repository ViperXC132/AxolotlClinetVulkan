...
public class SkinRenderer {
	...
	public static SkinRenderer getOrCreate(MinecraftClient minecraft, String id) {
		return renderers.computeIfAbsent(id, _id -> new SkinRenderer(minecraft, id));
	}

	private PlayerEntityModel<?> classicModel, slimModel;
	private final MinecraftClient minecraft;
	private final String id;

	private SkinRenderer(MinecraftClient minecraft, String id) {
		this.minecraft = minecraft;
		this.id = id;
	}

	public void render(GuiGraphics graphics, boolean classicVariant,
